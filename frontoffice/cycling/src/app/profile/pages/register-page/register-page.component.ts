...
export class RegisterPageComponent implements OnInit {
  ...
  // Lege user for input ??
  private user: User   = {  // temporarily limited to a subset of fields
    id: '',
    user_name: '',
    first_name: 'TBD',
    last_name: 'TBD',
  ...
  constructor(private userService: UserService) {}  // Registration and login of a new user handled in UserService ?
